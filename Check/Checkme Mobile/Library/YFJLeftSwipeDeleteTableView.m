...
- (id)initWithFrame:(CGRect)frame style:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        _deleteButton.frame = CGRectMake(CUR_SCREEN_W, 0, kDeleteButtonWidth, kDeleteButtonHeight);
        _deleteButton.backgroundColor = [UIColor redColor];
        _deleteButton.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin;
        
        [_deleteButton setTitle:DTLocalizedString(@"Delete", nil) forState:UIControlStateNormal];
